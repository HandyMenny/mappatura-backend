...
ZIPFILE=("Consultazione2021.tar.xz" "Consultazione2021_bianche2016.tar.xz" "Bando1Giga-v1.tar.xz" "Bando1Giga_TN_BZ-v2.tar.xz" "Consultazione2020.tar.xz" "Consultazione2019.tar.xz" "Consultazione2017.tar.xz")
DOWNLOAD_URL="https://media.githubusercontent.com/media/HandyMenny/database-infratel/main/"
DIR=("csv/Consultazione2021" "csv/Consultazione2021Bianche"  "csv/Bando1Giga"  "csv/Bando1Giga" "csv/Consultazione2020" "csv/Consultazione2019" "csv/Consultazione2017")
